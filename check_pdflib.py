...
#
# NOTES:
#   1. Remember to set credentials etc in the .conda/envs/arcgis_tools/etc/conda/activate.d/ files.
#   2. Sometimes if the system reboots, it won't mount the file server at /media/GIS.
#      You can fix it with "sudo mount /media/GIS"
#
"""
